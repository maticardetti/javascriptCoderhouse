...
let menuItems,
    ...
    validUser = {user: "maticardetti", pass: "matias"},
...
function updateOrder(clean) {
    ...
    order = [];
    form.innerHTML = '<input type="hidden" name="_next" value="https://maticardetti.github.io/javascriptCoderhouse/"><input type="hidden" name="_captcha" value="false">'; 
